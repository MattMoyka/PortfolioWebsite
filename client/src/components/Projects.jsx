  ...
  return (
    <div className='project-container'>
      ...
      <div className='project-card'>
        ...
        <a href='https://thedocks.netlify.app/' target="_blank"><img src={docks} className='project-img' /></a>
      </div>
      <div className='project-card'>
        <a href='https://salesverse.netlify.app/' target="_blank"><img src={salesverse} className='project-img' /></a>
        <div className='project-div'>
